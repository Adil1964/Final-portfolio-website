  ...
  return (
    <>
      ...
      <div className="flex items-center min-[1000px]:flex-row flex-col-reverse">
        ...
        >
          Hello! My Name Is M_Adil, a Pakistan-based Front-End Developer
          proficient in an array of modern technologies including HTML 5, CSS 3,
          React.js, Next.js, JavaScript, TypeScript, Tailwind CSS, Bootstrap,and more. I'm
          ...
          platforms, utilizing technologies such as React.js, Strapi, Tailwind,
          ...
          supported by my prior experiences, including my time as a Front-end web Developer, which honed my skills in
          teamwork, problem-solving, and operations management. Feel free to
          explore my projects and get in touch at{" "}
          <a
            href="mailto:mradil1117777@gmail.com"
