...
const Hero = () => {
  const [text, count] = useTypewriter({
    words: [
      ...
      "In Code We Trust",
      "Pushing Pixels & Deadlifts",
      "From JavaScript To JavaSips",
      "Building The Web One Line At A Time",
      "Uniting Tech & Wellness",
    ],
    loop: true,
    delaySpeed: 1000,
  });
  ...
  return (
    <section className="relative w-full h-screen mx-auto">
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            ...
            <span className="animate-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent font-black">
              MUHAMMAD <span className="hidden sm:inline">ADIL</span>
            </span>
          </h1>
      ...
      <div className="absolute right-5 top-1/2 -translate-y-1/2 flex flex-col gap-5 items-center md:mt-10 mt-5 md:gap-12">
        <Link target="_blank" to="https://www.linkedin.com/in/muhammad-adil-46261a28b/">
          <BsLinkedin
            size={30}
        ...
        <Link target="_blank" to="https://github.com/Adil1964/">
          <BsGithub
            size={30}
        ...
        <Link target="_blank" to="https://discord.com/">
          <BsDiscord
            size={30}
